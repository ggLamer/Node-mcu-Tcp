...
"  box-shadow: 0 0 20px rgba(0, 0, 0, .1);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.busvoltage.setText(_translate("MainWindow", "Dist: "))
    ...
    def update(self):
            ...
            while True:
                ...
                temp = requests.get(f"{ip}/temp").text
                humi = requests.get(f"{ip}/humidity").text
                precc = requests.get(f"{ip}/pressure").text

                dist = requests.get(f"{ip}/dist").text

                acceleration_x = requests.get(f"{ip}/acceleration_x").text
                acceleration_y = requests.get(f"{ip}/acceleration_y").text
                acceleration_z = requests.get(f"{ip}/acceleration_z").text

                rotation_x = requests.get(f"{ip}/rotation_x").text
                rotation_y = requests.get(f"{ip}/rotation_y").text
                rotation_z = requests.get(f"{ip}/rotation_z").text
                ...
                self.Acceleration_X.setText("X: {}".format(acceleration_x))
                self.Acceleration_Y.setText("Y: {}".format(acceleration_y))
                self.Acceleration_Z.setText("Z: {}".format(acceleration_z))
                
                self.Rotation_X.setText(" X: {}".format(rotation_x))
                self.Rotation_Y.setText(" Y: {}".format(rotation_y))
                self.Rotation_Z.setText(" Z: {}".format(rotation_z))

                self.busvoltage.setText("Dist: {} cm".format(dist))
